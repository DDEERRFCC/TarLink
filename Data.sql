...
VALUES (
        'a22be0052@utm.my',
        'A22BE0052',
        '$2b$12$REPLACE_WITH_BCRYPT_HASHED_PASSWORD',
        'student',
        '010203-14-5678',
        (
            SELECT application_id
            FROM studentapplication
            WHERE studentID = 'A22BE0052'
            LIMIT 1
        ), TRUE,
        FALSE,
        0,
...
VALUES (
        ...
        'a22be0052@utm.my',
        '2026-03-01',
        'JQSI Consultants Sdn Bhd',
        'No. 12, Jalan Sutera 2, Taman Sutera, 81300 Skudai, Johor, Malaysia',
        'Mr Lim Wei Jian',
        'weijian.lim@jqsi.com.my',
        '012-3456789',
        800.00,
        'Dr Ahmad Firdaus',
        'ahmad.firdaus@utm.my',
        '013-9876543',
        'approved',
        'Approved after company confirmed placement and supervisor details.',
        4,
        1,
        'BEQS',
        3,
        ...
        1,
        'Kolej Tun Razak, UTM Skudai, 81310 Johor Bahru, Johor',
        'sinnee.chua@gmail.com',
        'No. 8, Jalan Bakri 3, 84000 Muar, Johor, Malaysia',
        '019-2233445',
        ...
        'Basic',
        1,
        'Accepted via online form on 2026-03-01',
        'Acknowledged by student on 2026-03-01',
        'OFFER-2026-0001',
        'evidence_offer_letter.pdf',
        'Pn Siti Nur Aina',
        'sitinuraina@utm.my',
        1
    );
